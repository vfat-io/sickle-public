...
contract CTokenStorage {
    ...
    // Initial exchange rate used when minting the first CTokens (used when
    // totalSupply = 0)
    ...
    /**
     * @notice Total amount of outstanding borrows of the underlying in this
     * market
     */
     ...
     * @member principal Total balance (with accrued interest), after applying
     * the most recent balance-changing action
     * @member interestIndex Global borrowIndex as of the most recent
...
abstract contract CTokenInterface is CTokenStorage {
    ...
    /**
     * @notice Event emitted when pendingAdmin is accepted, which means admin is
     * updated
     */
    ...
    event NewReserveGuardian(
        address oldReserveGuardian, address newReserveGuardian
    );
     ...
     */
    event ReservesAdded(
        address benefactor, uint256 addAmount, uint256 newTotalReserves
    );
    ...
    event ReservesReduced(
        address admin, uint256 reduceAmount, uint256 newTotalReserves
    );
...
abstract contract CDelegatorInterface is CDelegationStorage {
     ...
     * delegation
     * @param allowResign Flag to indicate whether to call _resignImplementation
...
abstract contract CDelegateInterface is CDelegationStorage {
    ...
    /**
     * @notice Called by the delegator on a delegate to forfeit its
     * responsibility
     */
