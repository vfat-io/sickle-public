...
/// @notice These parameters are not defined as immutable (due to proxy pattern)
/// but are effectively immutable.
...
interface ICLPoolConstants {
    ...
    /// @notice The factory registry that manages pool <> gauge <> reward
